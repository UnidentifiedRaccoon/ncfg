...
export const players = {
  anna: {
    ...
    motivation: "Хочет открыть мастерскую и получить первые заказы. Полный запуск стоит 60.",
  ...
  mikhail: {
    ...
    name: "Михаил",
    priority: "За резерв",
    motivation: "Хочет оставить 60 на аренду и непредвиденные расходы.",
...
export const plans = [
  { id: "launch", title: "Полный запуск", amount: 60, response: "Анна может начать сразу. Михаилу нужно согласиться на меньший резерв." },
  { id: "pilot", title: "Небольшой пилот", amount: 40, response: "Пилот учитывает интересы обоих игроков." },
  { id: "wait", title: "Отложить запуск", amount: 0, response: "Михаил сохраняет запас. Анне важно договориться, когда вернуться к запуску." },
] as const;
