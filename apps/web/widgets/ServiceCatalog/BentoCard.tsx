...
export function BentoCard({
  ...
  return (
    <Reveal variant="card" from={featured ? "left" : "right"} delay={featured ? 0 : motionTokens.stagger} className={cn("relative min-w-0 h-full hover:z-10 focus-within:z-10", className)}>
      <CmsAwareLink
        href={href}
        ...
        className={cn(
          ...
          "motion-safe:hover:-translate-y-1 hover:shadow-lg hover:border-[#3B82F6]/25 hover:z-10",
